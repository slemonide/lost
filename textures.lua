...
function textures:load()
    ...
    textures:addBox("dirt_floor", "Objects/Floor", 0, 18, 7, 3)
    textures:addBox("dirt_wall", "Objects/Wall", 0, 18, 6, 3)
    textures:addBox("stone_floor", "Objects/Floor", 0, 9, 7, 3)
    textures:addBox("stone_wall", "Objects/Wall", 0, 12, 6, 3)
